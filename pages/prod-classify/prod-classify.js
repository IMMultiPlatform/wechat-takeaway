...
Page({
  ...
  loadProdData: function (options) {
    ...
    if (sts == 0) {
      // 分组标签商品列表
      let url = "/qcl-shop/prod/lastedProdByShop"
      this.getActProd(url)
      // this.getTagProd()
    } else if (sts == 1) {
      // 新品推荐
      ...
      // 请求商品分类分页列表
      let url = "/qcl-shop/category/productInfoList"
      this.getClassfyProd(url)
    }
  },
  // 获取热卖商品
